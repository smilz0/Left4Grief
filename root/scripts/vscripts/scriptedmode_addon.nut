Msg("scriptedmode_addon L4G\n");

Left4Grief_ScriptMode_Init <- ScriptMode_Init;
//=========================================================
...
function ScriptMode_Init( modename, mapname )
{
	...
	try
	{
		...
		bScriptedModeValid = Left4Grief_ScriptMode_Init( modename, mapname );
	}
	catch(exception)
	{
	...
	IncludeScript("left4grief");
	Left4Grief.Initialize(modename, mapname);
